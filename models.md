# Modélisation des Données dans l'Architecture Maedow (Zéro Modèle dans le JSX)

> **Guide de Conception des Types et Modèles de Données sous l'Architecture Maedow**  
> Ce document formalise la séparation absolue entre les modèles de données métier et les composants d'interface graphique (JSX/TSX), tout en appliquant le principe de pragmatisme typé de Maedow.

---

## 1. Le Principe Maedow : Pourquoi Séparer les Modèles du JSX ?

Dans de nombreuses bases de code, les interfaces TypeScript sont écrites directement au-dessus des composants React (`.tsx`). L'**Architecture Maedow** proscrit cette pratique pour 3 raisons fondamentales :
...
## 2. La Typologie des Modèles dans l'Architecture Maedow

L'Architecture Maedow distingue 5 catégories de modèles claires :
...
## 3. Règle du Pragmatisme Typé Maedow (Anti Over-Engineering)
...
## 4. Matrice de Localisation des Fichiers Maedow
...
### ✅ Clean Pattern Maedow : Découplage complet
